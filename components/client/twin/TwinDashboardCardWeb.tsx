...
/**
 * Web-only Twin Clone dashboard card — the lightweight version.
 * The mobile app gets the gamified holographic redesign via
 * TwinDashboardCard.tsx; the website intentionally stays clean to
 * keep page weight + motion budget low.
 */
export function TwinDashboardCardWeb({ stats, state, message }: Props) {
