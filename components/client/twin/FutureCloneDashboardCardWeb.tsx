...
/**
 * Web-only Future Clone dashboard card — the lightweight version.
 * Mobile app gets the gamified milestone-rail + transformation-beam
 * redesign via FutureCloneDashboardCard.tsx; web stays clean.
 */
export function FutureCloneDashboardCardWeb({ stats, workoutDoneToday }: Props) {
